...
export default function Home() {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const file = files[0];
    setIsLoading(true); // Informa a UI que o carregamento começou

    parseCsv(file, (imoveis) => {
      // falta adicionar uma etapa de transformação/limpeza dos dados se necessário
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4">Garimpeiro Genes</h1>
